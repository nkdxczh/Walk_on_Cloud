 ...
 */
public class AShowFriendsInfServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AShowFriendsInfServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Friends> lstInformation = new ArrayList<Friends>();
		lstInformation=userInfBiz.searchFriendInformation(user.getUserId());
		// -------------------响应客户端 JSon----------------
