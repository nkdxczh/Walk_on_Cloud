 ...
 */
public class AShowUserExchangeCommoditiesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AShowUserExchangeCommoditiesServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		lstInformation=commodityBiz.searchOwnerCommodities(user.getUserId(),1,2,0);
		// -------------------响应客户端 JSon----------------
