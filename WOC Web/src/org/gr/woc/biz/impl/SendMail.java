...
public class SendMail {
	public void SendEmailTest(String receiveaddress,String content) { 
	     ...
	     try { 
	         ...
	         transport.connect("smtp.qq.com", "754884172@qq.com", "lyh2005111"); 
	         ...
	         // 设置发信人地址 
	         String strFrom = "754884172@qq.com"; 
	         ...
	         // 设置收件人地址 
	         Address addressTo[] = { new InternetAddress(receiveaddress) }; 
	...
	public static void main(String args[]) throws Exception { 
        ...
        SEmail.SendEmailTest("1213652432@qq.com","用Java实现发送邮件"); 
    } 
} 
