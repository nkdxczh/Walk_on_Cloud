...
/**
 * Servlet implementation class GetUnfinishedOrderByUser
 */
public class GetUnfinishedOrderByUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetUnfinishedOrderByUserServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("lstUnfinishedOrdersByUser", lstUnfinishedOrdersByUser);
