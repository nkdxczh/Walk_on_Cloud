...
/**
 * Servlet implementation class GetAllSellerOrdersServlet
 */
public class GetAllSellerOrdersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAllSellerOrdersServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Order> lstAllSellerOrdersByUser=biz.searchAllSellerOrdersByUserId(user);
		request.setAttribute("lstAllSellerOrdersByUser", lstAllSellerOrdersByUser);
