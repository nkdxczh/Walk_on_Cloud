...
/**
 * Servlet implementation class GetLastMoviePostsServlet
 */
public class GetLastMoviePostsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetLastMoviePostsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("lstLastMoviePosts", lstBestPosts);
		System.out.println(lstBestPosts);
		RequestDispatcher dispatcher = request.getRequestDispatcher("jsp/forum/movie_index.jsp");
