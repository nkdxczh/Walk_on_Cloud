...
/**
 * Servlet implementation class GetOrderDetailInfByOrderId
 */
public class GetOrderDetailInfByOrderIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOrderDetailInfByOrderIdServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Order detaiOrder  = biz.searchInfById(order);
