...
/**
 * Servlet implementation class UpdatePostComtimeServlet
 */
public class UpdatePostComtimeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePostComtimeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IPostDao dao=new PostDaoImpl(TransactionManager.connection);
		int postid=Integer.parseInt(request.getParameter("postid"));
		Post post=new Post();
		post.setPostId(postid);
		dao.updateComTime(post);
