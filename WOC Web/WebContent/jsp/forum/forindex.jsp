...
<div id="123" style="width:220px; height:100px; z-index:9998; position:fixed; left:70%; top:10%; background-color : #F0F7F0; border:solid 2px #F0E0FE; opacity:0.7 ; text-align:center; display: none" >
			...
			<div class="container">
				<section id="dg-container" class="dg-container">
					<div class="dg-wrapper">
						<a href="#"><img src="jsp/forum/images/1.jpg" alt="image1" /></a>
						<a href="#"><img src="jsp/forum/images/2.jpg" alt="image2" /></a>
						<a href="#"><img src="jsp/forum/images/3.jpg" alt="image3" /></a>
						<a href="#"><img src="jsp/forum/images/4.jpg" alt="image4" /></a>
						<a href="#"><img src="jsp/forum/images/5.jpg" alt="image5" /></a>
						<a href="#"><img src="jsp/forum/images/6.jpg" alt="image1" /></a>
					</div>
				</section>
			</div>
		</div>
				...
				<div class="content">
					...
					<div class="section group">
						<div class="grid_1_of_3 images_1_of_3">
							<a href="jsp/forum/movie_index.jsp"><img
								src="jsp/forum/images/movie.jpg" alt="" /></a> <a
								href="jsp/forum/movie_index.jsp">
								<h3>电影</h3>
							</a>
						</div>
						<div class="grid_1_of_3 images_1_of_3">
							<a href="jsp/forum/music_index.jsp"><img
								src="jsp/forum/images/music.jpg" alt="" /></a> <a
								href="jsp/forum/music_index.jsp">
								<h3>音乐</h3>
							</a>
						</div>
						<div class="grid_1_of_3 images_1_of_3">
							<a href="jsp/forum/book_index.jsp"><img
								src="jsp/forum/images/book.jpg" alt="" /></a> <a
								href="jsp/forum/book_index.jsp">
								<h3>读书</h3>
							</a>
						</div>
						<div class="grid_1_of_3 images_1_of_3">
							<a href="jsp/forum/education_index.jsp"><img
								src="jsp/forum/images/education.jpg" alt="" /></a> <a
								href="jsp/forum/education_index.jsp">
								<h3>教学</h3>
							</a>
						</div>
						<div class="grid_1_of_3 images_1_of_3">
							<a href="jsp/forum/chat_index.jsp"><img
								src="jsp/forum/images/activity.jpg" alt="" /></a> <a
								href="jsp/forum/chat_index.jsp">
								<h3>畅谈</h3>
							</a>
						</div>
					</div>
					<h2 class="bg">帖子排行</h2>
					<div class="section group">
						<c:forEach items="${requestScope.lstBestPosts }" var="post">
							<div class="grid_1_of_3 images_1_of_3">
								<a href="jsp/forum/post.jsp?postid=${post.postId }"><img
									src="/WOC/jsp/forum/post_images/${post.resPath }" alt="" /></a> <a
									href="jsp/forum/post.jsp?postid=${post.postId }"><h3
										style="font-size: 20px">${post.postName }</h3></a>
							</div>
						</c:forEach>
					</div>
				</div>
				...
				<div class="sidebar">
					...
					<div class="sidebar-list" style="">
						...
						<marquee vspace="20" behavior="scroll" scrollAmount="1"
							...
							onMouseOut="this.start()" onMouseOver="this.stop()">
							<ul>
								<c:forEach items="${requestScope.lstHotPosts }" var="hotpost">
									<li><a href="jsp/forum/post.jsp?postid=${hotpost.postId }">${hotpost.postName }
									</a></li>
								</c:forEach>
							</ul>
						</marquee>
	...
	<div class="footer_container">
		<!--Footer Starts-->
		<footer style="margin-left: 184.5px">
			<address style="float: left;">Copyright © 2014 Spaceship.
