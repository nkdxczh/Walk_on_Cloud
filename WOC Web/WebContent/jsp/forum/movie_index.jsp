...
<body  onload="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);;">
	<c:if test="${empty requestScope.flag }">
		<script>
			window.location = "/WOC/GetLatestPostsByLayoutServlet?posttype=100";
		</script>
	</c:if>
...
<div><img src="jsp/forum/images/movie_bg.jpg" alt="" width="1348" height="484"/></div>
<div class="content-bg">
<div class="wrap">
<div class="main">
<div class="content">
	<h2>最新帖子</h2>
	<c:forEach items="${requestScope.lstLatestPostByLayout }" var="post">
	<div class="image group">
				<div class="grid images_3_of_1">
					<a href="jsp/forum/post.jsp?postid=${post.postId }"><img src="/WOC/jsp/forum/post_images/${post.resPath }"></a>
				</div>
				<div class="grid span_2_of_3">
					 <a href="jsp/forum/post.jsp?postid=${post.postId }"><h3>${post.postName }</h3></a>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt</p>
			   </div>
	 </div>
	 </c:forEach>
</div>
...
<div class="sidebar-list">
	<h2>版块公告</h2>
   <marquee vspace="20" behavior="scroll" scrollAmount="1" scrollDelay="0" direction="up" width="98%" valign="top" onMouseOut="this.start()" onMouseOver="this.stop()">
    <ul>
