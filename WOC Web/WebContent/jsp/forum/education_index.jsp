...
<body onload="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);;">
	<c:if test="${empty requestScope.flag }">
		<script>
			window.location = "/WOC/GetLatestPostsByLayoutServlet?posttype=200";
		</script>
	</c:if>
	...
	<div>
		<img src="jsp/forum/images/education_bg.jpg" alt="" width="1348"
			height="484" />
	</div>
				...
				<div class="content">
					...
					<c:forEach items="${requestScope.lstLatestPostByLayout }"
						...
						<div class="post" style="overflow: hidden">
							<a href="jsp/forum/post.jsp?postid=${post.postId }"><h3
									style="width: 50%">${post.postName }</h3></a>
