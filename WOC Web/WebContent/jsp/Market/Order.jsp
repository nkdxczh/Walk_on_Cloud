...
<body  onload="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);;">
    ...
    if(request.getAttribute("flag")==null){
        ...
        response.sendRedirect("/WOC/EmptyServlet?key=2&comid="+p);
    }
%>
			...
			<div class="full_page" style="width: 40%" style="margin: 0 auto;">
				<div class="col_left_main contact_page" align="center"
					...
					<div class="block" style="width: 100%">
						<form id="contact-us" action="/WOC/ApplyOrderServlet"
							method="post">
							<h3>物品信息</h3>
							<ul id="contact_form">
								<li><b>姓名：</b> <input type="text" name="name" id="name"
									value="" class="txt requiredField" /> <input type="hidden"
									name="comid" id="comid"
									value="<%=request.getParameter("comid") %>" /></li>
								<li><b>地区：</b> <input type="text" name="location"
									id="location" value="" class="txt requiredField" /></li>
								<li><b>电子邮箱：</b> <input type="text" name="email" id="email"
									value="" class="txt requiredField" /></li>
								<li><b>联系电话：</b> <input type="text" name="phone" id="phone"
									value="" class="txt requiredField" /></li>
								<li>
									<button name="submit" type="submit" class="subbutton brown_btn">提交!</button>
								</li>
							</ul>
						</form>
					</div>
