...
<body  onload="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);;">
	...
	<c:if test="${empty requestScope.flag }">
		<script>window.location="/WOC/EmptyServlet?key=1"; </script>
	</c:if>
...
<div id="123" style="width:220px; height:100px; z-index:9998; position:fixed; left:70%; top:10%; background-color : #F0F7F0; border:solid 2px #F0E0FE; opacity:0.7 ; text-align:center; display: none" >
	...
	<div class="theme-popover"
		style="background: url(jsp/WelcomePage/index_files/6462-11102Q54A389.jpg) no-repeat">
		...
		<div class="theme-popbod dform">
			<form class="theme-signin" name="loginform"
				...
				<ol>
					...
					<div style="float: right" class="w-txt" id="valcode"></div>
					</li>
				...
				<div class="col_left_main contact_page" align="center"
					...
					<div class="block" style="width: 100%">
						<form enctype="multipart/form-data" id="contact-us"
							action="/WOC/ReleaseCommodityServlet" method="post">
							<h3>物品信息</h3>
							<ul id="contact_form">
								<li><b>名称：</b> <input type="text" name="comName"
									id="contactName" value="" class="txt requiredField"
									placeholder="物品名称:" /></li>
								<li style="padding-left: 30%"><b
									style="float: left; margin-right: 5px">类型：</b> <select
									name="yongtu" id="yongtu">
										<option value="1">商品</option>
										<option value="2">交换品</option>
										<option value="3">漂流品</option>
								</select> <select name="leixing" id="leixing">
								...
								<li><p></p></li>
								<li><p></p></li>
								<li><b>地区：</b> <input type="text" name="comRegion"
									id="comRegion" value="" class="txt requiredField"
									placeholder="北京" /></li>
								<li><b>价格：</b> <input type="text" name="price" id="price"
									value="" class="txt requiredField" placeholder="200" /></li>
								<li><b>描述：</b> <textarea name="describe" id="describe"
										class="txtarea requiredField" placeholder="无"></textarea></li>
								<li><b>大图片：</b> <input type="file" name="fileField"
									id="fileField" style="width: 37%"
									onblur="if (this.value == '') {this.value = 'default.jsp';}">
								</li>
								<li><b>细节图：</b> <input type="file" name="fileField"
									id="fileField" style="width: 37%"
