...
public class ForumEducationFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater
				.inflate(R.layout.fragment_forum_education, container, false);
	...
	private List<Map<String, ?>> fetchPosts() {
		...
		String response = WebAccessUtils
				.httpRequest("AGetLatestPostsByLayoutServlet?posttype=200");
		System.out.println(response);
	...
	private class ViewOcl implements View.OnClickListener {
		...
		public void onClick(View view) {
			...
			case R.id.llMovie:
				...
				intent.setClass(ForumEducationFragment.this.getActivity(),
