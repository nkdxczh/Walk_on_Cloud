...
public class ForumMovieFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater
				.inflate(R.layout.fragment_forum_movie, container, false);
	...
	private List<Map<String, ?>> fetchPosts() {
		...
		String response = WebAccessUtils
				.httpRequest("AGetLatestPostsByLayoutServlet?posttype=100");
		System.out.println(response);
	...
	private class ViewOcl implements View.OnClickListener {
		...
		public void onClick(View view) {
			...
			case R.id.llMovie:
				...
				intent.setClass(ForumMovieFragment.this.getActivity(),
	...
	private class ItemOcl implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> adapter, View view,
			...
			Intent intent = new Intent();
			intent.putExtra("pid",
					(Integer) lstPostsData.get(position).get("pid"));
