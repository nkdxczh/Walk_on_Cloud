...
public class PersonFloatCommoditiesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(lstData.size()==0)
		{
			intent.setClass(PersonFloatCommoditiesActivity.this, InformationActivity.class);
			startActivity(intent);
			Toast.makeText(getApplicationContext(), "您的漂流商品信息为空", Toast.LENGTH_SHORT).show();
		}
	...
	private List<Map<String, ?>> fetchData() {
		...
		String response = WebAccessUtils.httpRequest("AShowUserFloatCommoditiesServlet",
