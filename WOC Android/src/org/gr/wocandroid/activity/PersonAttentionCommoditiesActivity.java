...
public class PersonAttentionCommoditiesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(lstData.size()==0)
		{
			intent.setClass(PersonAttentionCommoditiesActivity.this, InformationActivity.class);
			startActivity(intent);
			Toast.makeText(getApplicationContext(), "您的关注商品信息为空", Toast.LENGTH_SHORT).show();
		}
	...
	private List<Map<String, ?>> fetchData() {
		...
		String response = WebAccessUtils.httpRequest("AShowUserAttentionCommoditiesServlet",
