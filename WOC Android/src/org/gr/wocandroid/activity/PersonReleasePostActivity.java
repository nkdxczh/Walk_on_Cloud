...
public class PersonReleasePostActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(lstData.size()==0)
		{
			intent.setClass(PersonReleasePostActivity.this, InformationActivity.class);
			startActivity(intent);
			Toast.makeText(getApplicationContext(), "您的发布的帖子信息为空", Toast.LENGTH_SHORT).show();
		}
