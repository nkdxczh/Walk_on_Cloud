...
public class PersonAttentionPostActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(lstData.size()==0)
		{
			intent.setClass(PersonAttentionPostActivity.this, InformationActivity.class);
	...
	private List<Map<String, ?>> fetchData() {
		...
		String response = WebAccessUtils.httpRequest("AShowAttentionPostServlet",
